...
sys.path.insert(0, '/home/tqi-gcp-voice/Research/emotion_pi')

from s3prl import hub
from s3prl import downstream
from s3prl.downstream.runner_pi import Runner
...
def get_downstream_args():
    ...
    parser.add_argument('-m', '--mode', default='train', choices=['train', 'evaluate', 'inference'], required=False)
    ...
    parser.add_argument('-d', '--downstream', default='emotion_pi', choices=downstreams, help='\
    ...
    parser.add_argument('-u', '--upstream', default='wav2vec2', help=""
