...
def get_downstream_args():
    ...
    parser.add_argument('-d', '--downstream', default='emotion', choices=downstreams, help='\
    ...
    parser.add_argument('-k', '--upstream_ckpt', metavar='{PATH,URL,GOOGLE_DRIVE_ID}',
